...
class SPUGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_B', type=float, default=0.05, help='')  # netWork
            parser.add_argument('--lambda_C', type=float, default=0.35, help='')  # L1
            parser.add_argument('--lambda_D', type=float, default=0, help='')  # 全变差
            parser.add_argument('--lambda_E', type=float, default=0.15, help='')  # GAN
        return parser
