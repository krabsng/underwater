...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # visdom 和 HTML 可视化参数
        parser.add_argument('--display_freq', type=int, default=100, help='在屏幕上显示训练结果的频率')
        ...
        parser.add_argument('--update_html_freq', type=int, default=100, help='将训练结果保存到 HTML 的频率')
        ...
        # 网络保存和加载参数f
        parser.add_argument('--save_latest_freq', type=int, default=100, help='保存最新结果的频率')
        ...
        parser.add_argument('--n_epochs', type=int, default=80, help='具有初始学习率的 epoch 数')
        parser.add_argument('--n_epochs_decay', type=int, default=120, help='线性衰减学习率为零的 epoch 数')
